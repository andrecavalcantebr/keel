#!/bin/sh
# Minimal oracle for the m2-parser-header task. Not model-generated.
set -u
SRC=tools/cgen/src/engine/parser_header.c
TESTMAIN=tools/cgen/test/unit/parser_header_main.c
