...
keel_outcome_i32 app_cfg_soma(keel_arena *a, const char *caminho) { keel_outcome_i32 keel__rv0;
    ...
    keel_buffer_i32 xs = keel_buffer_i32_from((i32 *)keel_arena_alloc_n(a, app_cfg_MAX, sizeof(i32), _Alignof(i32)), app_cfg_MAX);
...
keel_outcome_i32 app_cfg_soma_scratch(const char *caminho) {
    ...
    if (!keel_arena_from_array(&t, keel__st0, sizeof keel__st0)) return keel_outcome_i32_fail(&resultado, 4);
