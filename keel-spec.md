...
- [1. Escopo e princípios](#1-escopo-e-princípios)
  - [1.1 Princípios de projeto](#11-princípios-de-projeto)
  - [1.2 Modelo de tradução e perfis](#12-modelo-de-tradução-e-perfis)
  - [1.3 Contrato de análise](#13-contrato-de-análise)
  - [1.4 Compatibilidade e conflitos léxicos](#14-compatibilidade-e-conflitos-léxicos)
- [2. Léxico, vocabulário e gramática](#2-léxico-vocabulário-e-gramática)
  - [2.1 Elementos léxicos](#21-elementos-léxicos)
  - [2.2 Palavras e gramática](#22-palavras-e-gramática)
  - [2.3 Reconhecimento](#23-reconhecimento)
  - [2.4 Grupos condicionais e delimitadores](#24-grupos-condicionais-e-delimitadores)
  - [2.5 Erros léxicos e sintáticos](#25-erros-léxicos-e-sintáticos)
- [3. keel por exemplos](#3-keel-por-exemplos)
- [4. Construções do núcleo](#4-construções-do-núcleo)
  - [4.1 Módulos e interoperabilidade](#41-módulos-e-interoperabilidade)
  - [4.2 Tipos, declarações e marcadores](#42-tipos-declarações-e-marcadores)
  - [4.3 Módulos genéricos](#43-módulos-genéricos)
  - [4.4 Resolução de operações](#44-resolução-de-operações)
  - [4.5 Indexação e `range-index`](#45-indexação-e-range-index)
  - [4.6 Cleanup léxico](#46-cleanup-léxico)
  - [4.7 Travessia sequencial](#47-travessia-sequencial)
  - [4.8 Execução particionada](#48-execução-particionada)
...
- [5. Protocolos e módulos da base](#5-protocolos-e-módulos-da-base)
  ...
  - [5.3 `keel.buffer`, `keel.slice`, `keel.range` e `keel.array`](#53-keelbuffer-keelslice-keelrange-e-keelarray)
  - [5.4 `keel.tagged`](#54-keeltagged)
  - [5.5 `keel.outcome` e `keel.corot`](#55-keeloutcome-e-keelcorot)
  - [5.6 `keel.routine`](#56-keelroutine)
  - [5.7 `keel.parallel`](#57-keelparallel)
  - [5.8 Biblioteca padrão](#58-biblioteca-padrão)
- [6. Diagnósticos e conformidade](#6-diagnósticos-e-conformidade)
  - [6.1 Emissão e responsabilidade](#61-emissão-e-responsabilidade)
  - [6.2 Catálogo](#62-catálogo)
  - [6.3 Implementação conforme](#63-implementação-conforme)
  - [6.4 Programa conforme e limites](#64-programa-conforme-e-limites)
  - [6.5 Variações e extensões](#65-variações-e-extensões)
  - [6.6 Referências](#66-referências)
<!-- /toc -->
