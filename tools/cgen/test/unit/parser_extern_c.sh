#!/bin/sh
# Oracle for the m2-parser-extern-c task. Not model-generated.
set -u
SRC=tools/cgen/src/engine/parser_extern_c.c
TESTMAIN=tools/cgen/test/unit/parser_extern_c_main.c
