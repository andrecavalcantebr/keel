/* gen/resultados/resultados.h — gerado de resultados/resultados.k, perfil C11.
   `corot` é tipo, não instância: um header de módulo, sem sufixo de argumento
   (backend §5.14). */
#ifndef RESULTADOS_RESULTADOS_H
#define RESULTADOS_RESULTADOS_H
#include "resultados/resultados.type.h"
