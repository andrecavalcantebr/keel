/* keel/keel_buffer_i32.h — generated from keel/buffer.k by cgen, C23 profile. */
...
[[nodiscard]]static inline i32 *keel_buffer_i32_push (keel_buffer_i32 *b);
#line 46 "keel/buffer.k"
[[nodiscard]]static inline i32 *keel_buffer_i32_push1(keel_buffer_i32 *b, i32 v);
#line 52 "keel/buffer.k"
[[nodiscard]]static inline i32 *keel_buffer_i32_pop(keel_buffer_i32 *b);
...
#line 36 "keel/buffer.k"
static inline i32    keel_buffer_i32_get (keel_buffer_i32 *b, size_t i) { return b->ptr[i]; }
#line 37 "keel/buffer.k"
...
#line 39 "keel/buffer.k"
static inline i32   *keel_buffer_i32_ptr1(keel_buffer_i32 *b, size_t i) { return &b->ptr[i]; }
#line 41 "keel/buffer.k"
[[nodiscard]]static inline i32 *keel_buffer_i32_push (keel_buffer_i32 *b) {
...
#line 72 "keel/buffer.k"
static inline keel_slice_i32 keel_buffer_i32_as_slice2(keel_buffer_i32 *b, size_t a, size_t c) {
    if (a > c || c > b->len) return (keel_slice_i32){0, b->ptr};
