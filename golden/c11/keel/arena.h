...
static inline void *keel_arena_alloc_n(arena *a, size_t n,
...
static inline size_t keel_arena_capacity(const arena *a);
static inline size_t keel_arena_length  (const arena *a);
static inline size_t keel_arena_mark    (const arena *a);
static inline void   keel_arena_reset   (arena *a);
static inline void   keel_arena_restore (arena *a, size_t m);
#endif /* KEEL_ARENA_H */
