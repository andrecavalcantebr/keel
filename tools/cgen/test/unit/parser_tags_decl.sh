#!/bin/sh
# Minimal oracle for the m2-parser-tags-decl task. Not model-generated.
set -u
SRC=tools/cgen/src/engine/parser_tags_decl.c
TESTMAIN=tools/cgen/test/unit/parser_tags_decl_main.c
...
tools/cgen/src/engine/parser_ident_list.c"
