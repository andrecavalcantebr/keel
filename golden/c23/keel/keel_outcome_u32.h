/* keel/keel_outcome_u32.impl.h — instância de `outcome u32` (backend §5.12). */
#ifndef KEEL_KEEL_OUTCOME_U32_IMPL_H
#define KEEL_KEEL_OUTCOME_U32_IMPL_H
...
#endif /* KEEL_KEEL_OUTCOME_U32_IMPL_H */
