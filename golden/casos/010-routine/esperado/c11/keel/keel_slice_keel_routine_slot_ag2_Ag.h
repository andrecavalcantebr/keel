/* keel/keel_slice_keel_routine_slot_ag2_Ag.impl.h — instância de `slice slot`.
   Arrastada pela instanciação de `keel.routine` (backend §4.3). */
#ifndef KEEL_KEEL_SLICE_KEEL_ROUTINE_SLOT_AG2_AG_IMPL_H
#define KEEL_KEEL_SLICE_KEEL_ROUTINE_SLOT_AG2_AG_IMPL_H
...
#endif /* KEEL_KEEL_SLICE_KEEL_ROUTINE_SLOT_AG2_AG_IMPL_H */
