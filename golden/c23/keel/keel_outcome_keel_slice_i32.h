...
static inline keel_outcome_keel_slice_i32 keel_outcome_keel_slice_i32_win(keel_slice_i32 v) { return (keel_outcome_keel_slice_i32){ keel_outcome_OK, v }; }
static inline keel_outcome_keel_slice_i32 keel_outcome_keel_slice_i32_fail(i32 c) { return (keel_outcome_keel_slice_i32){ c, (keel_slice_i32){0,NULL} }; }
static inline keel_outcome_keel_slice_i32 keel_outcome_keel_slice_i32_none(void) { return (keel_outcome_keel_slice_i32){ keel_outcome_NONE, (keel_slice_i32){0,NULL} }; }
#endif
