/* gen/app/pos.c — gerado de app/pos.k, perfil C11.
...
static app_pos_position app_pos_position_from(keel_arena *a, size_t cap) {
    f32 *x = (f32 *)keel_arena_alloc_n(a, cap, sizeof(f32), _Alignof(f32));
    f32 *y = (f32 *)keel_arena_alloc_n(a, cap, sizeof(f32), _Alignof(f32));
