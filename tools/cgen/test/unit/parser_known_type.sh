#!/bin/sh
# Minimal oracle for the m2-parser-known-type task. Not model-generated.
set -u
SRC=tools/cgen/src/engine/parser_known_type.c
TESTMAIN=tools/cgen/test/unit/parser_known_type_main.c
