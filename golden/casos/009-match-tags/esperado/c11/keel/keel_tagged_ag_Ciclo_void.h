/* keel/keel_tagged_ag_Ciclo_void.impl.h — instância de `tagged Ciclo void`.
...
#ifndef KEEL_KEEL_TAGGED_AG_CICLO_VOID_IMPL_H
#define KEEL_KEEL_TAGGED_AG_CICLO_VOID_IMPL_H
...
#endif /* KEEL_KEEL_TAGGED_AG_CICLO_VOID_IMPL_H */
